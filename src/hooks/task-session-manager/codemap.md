...
- **revived-run-tracker.ts**: Logs terminal notification transport acceptance, each failed attempt (including timeout), lease deferral, and once-only ownership release to the fallback publication wake.
